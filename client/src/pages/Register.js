        ...
        <div className="flex items-center justify-center p-8 bg-gray-900 text-gray-100">
          <div className="w-full max-w-md">
            <div className="text-center mb-6">
              ...
              <p className="text-sm opacity-80">Sign up to start backtesting and live trading</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center text-sm mt-6">
                <Link to="/login" className="text-indigo-400 hover:underline">Already have an account? Sign in</Link>
              </div>
            </form>
          </div>
        </div>
